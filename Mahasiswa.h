...
//Insert node di awal
void insertAwal(address *Head, address insert);

//Insert node di akhir
void insertAkhir(address *Head, address insert);

//insert node setelah node lain
void insertAfter(address *Before, address insert);

//delete node awal
void deleteAwal(address *Head);

//delete node Akhir
void deleteAkhir(address *Head);
...
void modifyAwal(address *Head, address modify);

//memodifikasi nilai node di akhir
void modifyAkhir(address *Head, address modify);

//memodifikasi nilai node setelah nilai node lainnya
void modifyAfter(address *Head, address modify);
...
List *filterByNilai(List L, float Nilai);
